...
async def search_(message: types.Message):
    await message.answer(
        ...
        reply_markup=user_search_cbuttons(
            search_clinic="Klinika bo'yicha qidirish",
            search_doctor="Shifokor sohasi bo'yicha qidirish",
            search_address="Eng yaqin klinikalar ro'yxatini chiqarish",
            nearest_clinics="Manzil bo'yicha qidirish",
